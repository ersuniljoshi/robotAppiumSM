...
#    hide keyboard
#    wait until page contains element  xpath=//android.webkit.WebView[@content-desc='Survey Monkey']/android.view.View[5]/android.view.View[1]/android.widget.EditText
#    sleep  10
#    click element  xpath=//android.webkit.WebView[@content-desc='Survey Monkey']/android.view.View[5]/android.view.View[1]/android.widget.EditText
#    sleep  2
#    input text  xpath=//android.webkit.WebView[@content-desc='Survey Monkey']/android.view.View[5]/android.view.View[1]/android.widget.EditText  ICC
#    #hide keyboard
#    #wait until page contains element  xpath=//android.webkit.WebView[@content-desc='Survey Monkey']/android.view.View[6]/android.view.View[1]/android.widget.EditText
#    #input text   xpath=//android.webkit.WebView[@content-desc='Survey Monkey']/android.view.View[6]/android.view.View[1]/android.widget.EditText  Trex
#    hide keyboard
#    click element  xpath=//android.widget.TextView[@resource-id='com.surveymonkey:id/action_save']
